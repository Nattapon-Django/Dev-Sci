...
<body class="skin-green" onload="init();">
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <div class="dropdown mr-3" style="display:inline;">
                                    <button class="btn btn-danger dropdown-toggle" type="button" data-toggle="dropdown">Dashboard
                                        <span class="caret"></span></button>
                                    <ul class="dropdown-menu">
                                        <!-- <li><a class="dropdown-item" href="http://localhost:1880/ui/#!/<?php echo $_GET['dv_id']; ?>?socketid=bc7euIluVYpV2pgXAACv" target="_blank"><i class="fa fa-location-arrow" aria-hidden="true"></i> Realtime</a></li> -->
                                ...
                                <!-- <button class="btn btn-danger"><i class="fa fa-flag" aria-hidden="true"></i>
                                    <?php $dateNow = date("Y"); ?>
...
<!-- 
                                <button class="btn btn-success"><i class="fa fa-download"></i>
                                    <a href="http://localhost/fride/csv/device<?php echo $_GET['dv_id']; ?>.csv" style="color:white;text-decoration:none;">Export csv</a>
                                </button> -->
